...
const Slider = () => {
  const FollowingArray = [
    {
      background: images.nftvideo1,
      user: images.user3,
    },
    {
      background: images.nftvideo2,
      user: images.user4,
    },
    {
      background: images.nftvideo5,
      user: images.user5,
    },
    {
      background: images.nftvideo6,
      user: images.user6,
    },
    {
      background: images.nftvideo3,
      user: images.user1,
    },
    {
      background: images.nftvideo4,
      user: images.user2,
    },
